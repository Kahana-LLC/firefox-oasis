...
export const UTTERANCE_FIXTURES: UtteranceExpectation[] = [
  ...
  {
    phrase: "creat a research brief on this tab group",
    route: "build_research_brief",
    useActiveGroup: true,
    inferTopic: true,
  },
  {
    phrase: "give me insights from my shopping tabs",
    route: "build_research_brief",
    scope: "relevant",
    topic: "shopping",
    inferTopic: true,
  ...
  {
    phrase: "summarize everything open about react hooks",
    route: "build_research_brief",
    scope: "relevant",
    topic: "react hooks",
    inferTopic: true,
  ...
  {
    phrase: "consolidate findings across my sports tabs",
    route: "build_research_brief",
    scope: "relevant",
    topic: "sports",
    inferTopic: true,
  ...
  {
    phrase: "create a summary of these tabs",
    route: "build_research_brief",
    scope: "window",
    inferTopic: true,
  },
  {
    phrase: "create a summary of this tab group",
    route: "build_research_brief",
    useActiveGroup: true,
    inferTopic: true,
  },
  {
    phrase: "create a summary of the tabs related to llms",
    route: "build_research_brief",
    scope: "relevant",
    topic: "llms",
    inferTopic: true,
  ...
  {
    phrase: "summarize tabs about react hooks",
    route: "build_research_brief",
    scope: "relevant",
    topic: "react hooks",
    inferTopic: true,
