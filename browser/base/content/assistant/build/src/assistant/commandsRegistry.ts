...
import {
  ...
  BuildCompetitiveIntelBriefCommand,
  DraftOutreachEmailCommand,
  RunCompetitiveIntelCommand,
...
const COMMAND_ARG_SCHEMA: Readonly<Record<string, string>> = {
  ...
  close_tab: `{"index?":"number","query?":"string","confirmed?":"boolean"}`,
  focus_tab: `{"query":"string"}`,
