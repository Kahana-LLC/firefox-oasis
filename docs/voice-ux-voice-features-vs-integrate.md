...
- `browser/base/content/assistant/VOICE_INPUT_SETUP.md` — Lambda payload, env vars, troubleshooting (403, IAM).
- `docs/voice-features-branch-setup.md` — checking out `voice-features` and manual tests.
- `docs/voice-ux-test-plan-and-guardrails.md` — voice UX test matrix, release checklist, scope/derailment guardrails, standards references.
